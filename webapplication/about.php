...
<ul class="main-menu__items-wrap clearfix">
                ...
                <li class="main-menu__item current" style="float:right"><a style="color:inherit" href="./about.php">about</a></li>
...
<div class="h2">About the Platform </div>
...
<ul style="padding-left:30px">
	<li>enhancing collaboration across Centers, CGIAR Research Programs (CRPs) and partners to leverage state-of-the-art data standards, analytics and ICTs</li>
	<li>enabling unrestricted discoverability of inter-linked data sets to understand and tackle multifaceted challenges in data and evidence-driven ways</li>
	<li>leveraging CGIAR expertise with external partners to broaden and deepen experience and capacity and position CGIAR in the broader big data and ICT sphere to establish CGIAR as an innovative thought leader</li>
	<li>developing initiatives using proven big data innovations to drive agricultural growth in developing countries</li>
</ul> 
<br>

<div style="border: 1px solid #f7941d;">
 <center>The CGIAR Platform for Big Data in Agriculture is implemented with support from the CGIAR Trust Fund and bilateral funding agreements.</center>
</div>


<br>
<button class="btn button button-orange" onclick="move()">More about the Platform</button>

<script>
function move()
{
	window.open(\'https://bigdata.cgiar.org/about-the-platform/\',\'_blank\');
     
} 
</script>
<br>
<br>
<div class="h2">About GARDIAN</div>


<p>
The primary focus in the early years of the Platform is on getting CGIAR data resources organized and FAIR (Findable, Accessible, Interoperable, Reusable). The Platform is working on establishing the infrastructures, tools, and approaches to make CGIAR data visible and usable. It is also working with all 15 Centers to build capacity across the CGIAR system to effectively manage its valuable data resources.
</p>
...
<div class="h2"> GARDIAN Support</div>

<p>

 If you are experiencing issues with GARDIAN or have feedback for us, please let us know via the form below<br>
</p>



<button class="btn button button-orange" onclick="move1()">Provide feedback</button>

<script>
function move1()
{
        window.open(\'./contactform.php\',"_self");
