...
<html lang="en">
  <head> 
    ...
    <title>GARDIAN Exploration</title>
...
<script src="assets/js/app_geo.js"></script>
...
<ul class="main-menu__items-wrap clearfix">
                ...
                <li class="main-menu__item current"><a style="color:inherit" href="./exploration.php" title = "Explore geo-referenced or semantically-enabled data here">data exploration</a></li>
    ...
    <main class="main row search-results">
	  ...
	  <a  href="" class="tablink fa fa-globe" ng-class="{ active: $storage.activeTab == 'tab3' }" ng-click="setActiveTab2('tab3')">Georeferenced Data</a>
          <a  href="" class="tablink fa fa-cogs" ng-class="{ active: $storage.activeTab == 'tab4' }" ng-click="setActiveTab2('tab4')">Semantically-enabled Data</a>
	</div>




<div class="column white-bg tabs-content-wrap" ng-controller="searchResultsController" ng-init="searchBodyInit()">




	<div id="tab4" class="tabs-content" ng-class="{'active': ($storage.activeTab == 'tab4')}">

		<div class="boxed white-bg" style="margin-bottom:0px;padding-bottom:0px">   
	<div class="h3"><p>Imagine if different datasets could be easily aggregated, leading to new analyses and interpretation. Imagine getting new and better meaning from vast amounts of data.
	Here we give you a glimpse of the possibilities in a world where semantic interoperability (from FAIR data) provides new meaning, through easy querying, organization, and aggregration of varied but related data.</p>
	<p>Explore semantically-enabled and standards-compliant datasets by running a few queries as suggested below.</p> 
	</div>				
	<br>
	<span class="h2"> GARDIAN, please give me data for: </span><br><br>
	<div class="h3">
		<ul style="padding-left:25px">
			<li> 
				maize yields under *complete* and *no* fertilisation in
				<a href="" class="btn button toggle-lightbox-2" id="btn1">Africa</a>
					<button class="btn button button-orange questionn question1" type="submit" disabled id="g1">GO <i class="fa fa-magic"></i></button>
			</li>
			<li style="padding-top:20px">							
				yields of  not-improved 
				...
				<button class="btn button button-orange questionn question2" type="submit" id="g2" disabled>GO <i class="fa fa-magic"></i></button>
			</li>
			<li style="padding-top:5px"> 
				maize yields in
                <a href="" class="btn button toggle-lightbox-2" id="btn5">Africa</a> 
					<button class="btn button button-orange questionn question2" type="submit" id="g5" disabled>GO <i class="fa fa-magic"></i></button>
            </li>
			<li style="padding-top:20px"> 
				avg. maize yields of conservation vs. conventional practice in                                                       
				<a href="" class="btn button toggle-lightbox-2" id="btn6">Africa</a>
				<button class="btn button button-orange  question4" type="submit" id="g6" disabled>GO <i class="fa fa-magic"></i></button>
            </li>
            <li style="padding-top:20px"> 
				avg. maize yields of conservation vs. conventional tillage process in clay soil in
                <a href="" class="btn button toggle-lightbox-2" id="btn7">Africa</a>
				<button class="btn button button-orange  question4" type="submit" id="g7" disabled>GO <i class="fa fa-magic"></i></button>
			</li>
			<li style="padding-top:20px"> 
				...
				<button class="btn button button-orange questionn question3" type="submit" id="g3" disabled>GO <i class="fa fa-magic"></i></button> 
			</li>
			<li style="padding-top:5px">
				soil texture of 
				...
				<button class="btn button button-orange  question4" type="submit" id="g4" disabled>GO <i class="fa fa-magic"></i></button>
			</li>
...
<div class="column small-12 post-content" id = "fromDT" hide>
        <div class="boxed white-bg" style="margin-bottom:0px;padding-bottom:0px" id="insideDT">
                <span class="h2"><i class="fa fa-table"></i> <span id="data_from"></span></span><a type="button" id="toggle-lightbox-sparql_box" class="btn button toggle-lightbox-sparql_box" style="float:right;">SPARQL</a><br><br>
...
<div class="column small-12 medium-12 post-content" id="sparql_data">
	<div class="boxed white-bg" style="margin-bottom:0px;padding-bottom:0px">
		<span class="h2"><i class="fa fa-table"></i><span id="data_label"></span> </span>
