...
$publications_1 = cgiar_fair_publications('2018','1900',$center);
$publications_2 = cgiar_fair_publications('2018','1900',$center);



$datasets_1 = cgiar_fair_datasets('2018','1900',$center);
$datasets_2 = cgiar_fair_datasets('2018','1900',$center);
...
<html lang="en">
  <head>
	...
	<script type="text/javascript">var jPub1 ='.$publications_1.'</script>
        <script type="text/javascript">var jPub2 ='.$publications_2.'</script>

        <script type="text/javascript">var jDat1 ='.$datasets_1.'</script>
        <script type="text/javascript">var jDat2 ='.$datasets_2.'</script>
...
$body = ' <body>
    ...
    <header class="site-header">
      <div class="site-header__top black-bg">
		...
		<li class="main-menu__item current"><a style="color:inherit" href="./statistics.php">analytics</a></li>
        ...
        <div class="row">
          <div class="column small-12">
            <form class="search-form">
              <h3 class="h1 search-form-title">DATA SEARCH</h3>
              <div class="row">
                ...
                <div class="column shrink">
                  <a href="/search.php#!/{{$root.query}}/{{access.value}}/{{operator.value}}/{}" class="btn button button-white" type="submit">SEARCH</a>
                </div>
              </div>
            </form>
          </div>
      ...
      <div class="site-header__bottom white-bg">
        <div class="row">
          <nav class="column small-12 secondary-menu text-center">
            <ul class="secondary-menu__items-wrap clearfix">
              <li class="nav__item "><a style="color:inherit" href="./statistics.php" class="fa fa-chart-line"><span class="nav__item--title">Openness</span></a></li>
              <li class="nav__item current"><i style="color:inherit" href="" class="fa fa-bullseye"><span class="nav__item--title">Fair Compliance</span></i></li>
	       <li class="nav__item"><a style="color:inherit" href="./metrics.php" class="fa fa-info-circle"><span class="nav__item--title">Fair Metrics</span></a></li>
	...
	<div class="column small-12 medium-12 post-content filter clearfix">
			...
			<div class="column small-12 medium-6 post-content" >
					<div class="boxed white-bg" >
						...
						<center><div id="container_1"  ></div></center>
					</div>
				</div>
                        <div class="column small-12 medium-6 post-content">
                                <div class="boxed white-bg">
					<h1 style="margin-bottom:0px">Datasets</h1><h3> FAIRNESS</h3>
                                	<center><div id="container_2"></div></center>
				</div>
                        </div>
...
<footer class="site-footer orange-bg">
      ...
      <div class="row site-footer__bottom">
        ...
        <div class="column small-8 ">
          <nav class="column small-11 align-self-bottom footer-menu">
          <ul class="footer-menu__items-wrap clearfix text-right">
