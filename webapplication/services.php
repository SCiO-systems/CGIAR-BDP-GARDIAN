...
<ul class="main-menu__items-wrap clearfix">
                ...
                <li class="main-menu__item current" style="float:right"><a style="color:inherit" href="./services.php">services</a></li>
	...
	<article class="column small-12 row medium-12 main-content white-bg">

	<div class="boxed column small-6 post-title white-bg">
	<center>
		<div class="column small-6">
		<a href="./api/" target="_blank" rel="noopener noreferrer" style="display: block; cursor: pointer; margin: 0px 0px -15.5px; text-decoration: none;">

		<i class="fas fa-cogs fa-9x" style="color:#f7941d"><br><center><p style="font-size:26px;color:#4b4b4b; font-family:Roboto Condensed">API</p></center></i>
 ...
 <div class="boxed column small-6 post-title white-bg">
        <center>
                <div class="column small-6">
                <a href="https://github.com/ScioSystems/CGIAR-BDP-GARDIAN" target="_blank" rel="noopener noreferrer" style="display: block; cursor: pointer; margin: 0px 0px -15.5px; text-decoration: none;">

                <i class="fab fa-github fa-9x" style="color:#f7941d"><br><center><p style="font-size:26px;color:#4b4b4b;font-family:Roboto Condensed;font-weight:900">Source Code</p></center></i>
